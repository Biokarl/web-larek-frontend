...
Находится в основе практически всех частей проекта, реализует методы для работы
...
Находится в основе практически всех частей проекта, реализует методы для работы с карточками товаров.
...
Находится в основе практически всех частей проекта, реализует методы для работы с корзиной товаров.
...
Конструктор принимает такие аргументы:
    ...
    3. options - опции, наследуемые от класса Api
...
Реализует работу с майл и телефоном
